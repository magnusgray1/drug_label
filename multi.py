...
file = open("./results/multi/train_logs/tlog_bert_m.txt", "w")
...
plt.legend()
plt.show()
plt.savefig('./results/multi/graphs/graph_bert_m.png')
plt.clf()
...
# PLR TEST - LABEL 2 - Adverse
plr_test_2 = plr_test[plr_test["label"] == 2]
plr_test_data_2 = Dataset.from_pandas(plr_test_2)
tokenized_plr_test_dataset_2 = plr_test_data_2.map(tokenize_function, batched=True)

pred = trainer.predict(tokenized_plr_test_dataset_2)
preds = np.argmax(pred.predictions, axis=-1)
metric = load_metric("accuracy")
output = metric.compute(predictions=preds, references=pred.label_ids)
print("PLR Test: Label 2 Accuracy:", output)
test_results["PLR Test: Label 2 Accuracy"] = output


# PLR TEST - LABEL 3 - Other
plr_test_3 = plr_test[plr_test["label"] == 3]
plr_test_data_3 = Dataset.from_pandas(plr_test_3)
tokenized_plr_test_dataset_3 = plr_test_data_3.map(tokenize_function, batched=True)

pred = trainer.predict(tokenized_plr_test_dataset_3)
preds = np.argmax(pred.predictions, axis=-1)
metric = load_metric("accuracy")
output = metric.compute(predictions=preds, references=pred.label_ids)
print("PLR Test: Label 3 Accuracy:", output)
test_results["PLR Test: Label 3 Accuracy"] = output
...
# Non-PLR TEST - LABEL 2 - Adverse
non_plr_test_2 = non_plr_test[non_plr_test["label"] == 2]
non_plr_test_data_2 = Dataset.from_pandas(non_plr_test_2)
tokenized_non_plr_test_dataset_2 = non_plr_test_data_2.map(tokenize_function, batched=True)

pred = trainer.predict(tokenized_non_plr_test_dataset_2)
preds = np.argmax(pred.predictions, axis=-1)
metric = load_metric("accuracy")
output = metric.compute(predictions=preds, references=pred.label_ids)
print("Non-PLR Test: Label 2 Accuracy:", output)
test_results["Non-PLR Test: Label 2 Accuracy"] = output


# Non-PLR TEST - LABEL 3 - Other
non_plr_test_3 = non_plr_test[non_plr_test["label"] == 3]
non_plr_test_data_3 = Dataset.from_pandas(non_plr_test_3)
tokenized_non_plr_test_dataset_3 = non_plr_test_data_3.map(tokenize_function, batched=True)

pred = trainer.predict(tokenized_non_plr_test_dataset_3)
preds = np.argmax(pred.predictions, axis=-1)
metric = load_metric("accuracy")
output = metric.compute(predictions=preds, references=pred.label_ids)
print("Non-PLR Test: Label 3 Accuracy:", output)
test_results["Non-PLR Test: Label 3 Accuracy"] = output
...
# UK SmPC TEST - LABEL 2 - Adverse
uk_test_2 = uk_test[uk_test["label"] == 2]
uk_test_data_2 = Dataset.from_pandas(uk_test_2)
tokenized_uk_test_dataset_2 = uk_test_data_2.map(tokenize_function, batched=True)

pred = trainer.predict(tokenized_uk_test_dataset_2)
preds = np.argmax(pred.predictions, axis=-1)
metric = load_metric("accuracy")
output = metric.compute(predictions=preds, references=pred.label_ids)
print("UK SmPC Test: Label 2 Accuracy:", output)
test_results["UK SmPC Test: Label 2 Accuracy"] = output


# UK SmPC TEST - LABEL 3 - Other
uk_test_3 = uk_test[uk_test["label"] == 3]
uk_test_data_3 = Dataset.from_pandas(uk_test_3)
tokenized_uk_test_dataset_3 = uk_test_data_3.map(tokenize_function, batched=True)

pred = trainer.predict(tokenized_uk_test_dataset_3)
preds = np.argmax(pred.predictions, axis=-1)
metric = load_metric("accuracy")
output = metric.compute(predictions=preds, references=pred.label_ids)
print("UK SmPC Test: Label 3 Accuracy:", output)
test_results["UK SmPC Test: Label 3 Accuracy"] = output


file = open("./results/multi/eval_logs/elog_bert_m.txt", "w")
...
file = open("./results/multi/train_logs/tlog_albert_m.txt", "w")
file.write(repr(history))
file.close
...
plt.legend()
plt.show()
plt.savefig('./results/multi/graphs/graph_albert_m.png')
plt.clf()
...
file = open("./results/multi/eval_logs/elog_albert_m.txt", "w")
file.write(repr(test_results))
file.close
...
file = open("./results/multi/train_logs/tlog_distilbert_m.txt", "w")
file.write(repr(history))
file.close
...
plt.legend()
plt.show()
plt.savefig('./results/multi/graphs/graph_distilbert_m.png')
plt.clf()
...
file = open("./results/multi/eval_logs/elog_distilbert_m.txt", "w")
file.write(repr(test_results))
file.close
...
file = open("./results/multi/train_logs/tlog_roberta_m.txt", "w")
file.write(repr(history))
file.close
...
plt.legend()
plt.show()
plt.savefig('./results/multi/graphs/graph_roberta_m.png')
plt.clf()
...
file = open("./results/multi/eval_logs/elog_roberta_m.txt", "w")
file.write(repr(test_results))
file.close
